...
import com.riad.dictionary.fragmentspolitical.FragmentsAcronym;
import com.riad.dictionary.fragmentspolitical.FragmentsDzoDefinition;
import com.riad.dictionary.fragmentspolitical.FragmentsSpeech;
...
public class WordMeaningActivityPolitical extends AppCompatActivity {
   ...
   //jkghil public String enDefinition;
    public String dzoDefinition_political;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  d = myDbHelper.getMeaning(dzoWord);
        ...
        if (c.moveToFirst()) {
            ...
            dzoDefinition_political=c.getString(c.getColumnIndex("dzo_definition"));
   ...
   /*     if (d.moveToFirst()) {
    ...
    private void setupViewPager(ViewPager viewPager){
       ...
       // adapter.addFrag(new FragmentDefinition(), "Definition");
        adapter.addFrag(new FragmentsDzoDefinition(), "Definition");
        adapter.addFrag(new FragmentsAcronym(), "Acronym");
        adapter.addFrag(new FragmentsSpeech(), "Speech");
