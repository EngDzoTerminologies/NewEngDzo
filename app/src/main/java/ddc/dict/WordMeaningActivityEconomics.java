...
import ddc.dict.FragmentsEconomics.FragmentAcronym;
import ddc.dict.FragmentsEconomics.FragmentDzoDefinition;
import ddc.dict.FragmentsEconomics.FragmentSpeech;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class WordMeaningActivityEconomics extends AppCompatActivity {

    private ViewPager viewPager;

    String enWord;
    DatabaseHelperEconomics myDbHelper;
    Cursor c = null;
    String dzoWord;
   ...
   //jkghil public String enDefinition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_meaning_economics);

        //received values
        Bundle bundle = getIntent().getExtras();
        bundlevalue = bundle.getInt("key");
        //SharedPreferences sharedPreferences = getApplication().getSharedPreferences("economicspreference", 0);
      ...
      //  d = myDbHelper.getMeaning(dzoWord);
        ...
        btnSpeak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tts = new TextToSpeech(WordMeaningActivityEconomics.this, new TextToSpeech.OnInitListener() {
                    @Override
