...
import ddc.dict.fragmentsHealth.FragmentAcronym;
import ddc.dict.fragmentsHealth.FragmentDzoDefinition;
import ddc.dict.fragmentsHealth.FragmentSpeech;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class WordMeaningActivityHealth extends AppCompatActivity {

    private ViewPager viewPager;

    String enWord;
    DatabaseHelperHealth myDbHelper;
    Cursor c = null;
    String dzoWord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_meaning_health);

        //received values
        Bundle bundle = getIntent().getExtras();
        bundleValue = bundle.getInt("key");
        //SharedPreferences sharedPreferences = getApplication().getSharedPreferences("healthpreference", 0);
      ...
      //  d = myDbHelper.getMeaning(dzoWord);
        ...
        btnSpeak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tts = new TextToSpeech(WordMeaningActivityHealth.this, new TextToSpeech.OnInitListener() {
                    @Override
