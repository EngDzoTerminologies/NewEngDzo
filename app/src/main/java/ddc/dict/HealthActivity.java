...
public class HealthActivity extends AppCompatActivity {
    ...
    static DatabaseHelperHealth myDbHelper;
    static boolean databaseOpened=false;
    SimpleCursorAdapter suggestionAdapter;

    Context context = HealthActivity.this;
    public static final String pref_name = "healthpreference";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookdescription = findViewById(R.id.somedescriptionH);

        sharedPreferences.getInt("healthSwitchValue", 1);
        update(sharedPreferences);

        if (sharedPreferences.getInt("healthSwitchValue", 1) == 1) {
            searchLanguage.setChecked(false);
            bookdescription.setText(R.string.health_description);
        } else {
            searchLanguage.setChecked(true);
            bookdescription.setText(R.string.health_descriptionDzo);
        ...
        searchLanguage.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    editor.putInt("healthSwitchValue", 0);
                    editor.apply();
                    ...
                    editor.putInt("healthSwitchValue", 1);
                    editor.apply();
                    update(sharedPreferences);
                    bookdescription.setText(R.string.health_description);
        ...
        myDbHelper = new DatabaseHelperHealth(this);

        if (myDbHelper.checkDataBase()) {
            openDatabase();

        } else {
            LoadDatabaseAsyncHealth task = new LoadDatabaseAsyncHealth(HealthActivity.this);
            task.execute();
        }
    ...
    public void update( final SharedPreferences sharedPreferences)
    {
        ...
        suggestionAdapter = new SimpleCursorAdapter(HealthActivity.this,
        ...
        search.setOnSuggestionListener(new SearchView.OnSuggestionListener() {
            ...
            public boolean onSuggestionClick(int position) {
                ...
                if(sharedPreferences.getInt("healthSwitchValue", 1) == 1)
                {
                    ...
                    Intent intent = new Intent(HealthActivity.this, WordMeaningActivityHealth.class);
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query)
            {
                ...
                if(c.getCount()==0)
                {
                    if(sharedPreferences.getInt("healthSwitchValue", 1) == 1){
                        search.setQuery("",false);
                        AlertDialog.Builder builder = new AlertDialog.Builder(HealthActivity.this, R.style.MyDialogTheme);
