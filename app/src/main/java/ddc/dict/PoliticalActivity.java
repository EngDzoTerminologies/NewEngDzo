...
public class PoliticalActivity extends AppCompatActivity {
    ...
    Context context = PoliticalActivity.this;
    public static final String pref_name = "politicalpreference";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookdescription = findViewById(R.id.somedescriptionP);

        sharedPreferences.getInt("politicalSwitchValue", 1);
        update(sharedPreferences);

        if (sharedPreferences.getInt("politicalSwitchValue", 1) == 1) {
            searchLanguage.setChecked(false);
            bookdescription.setText(R.string.political_description);
        } else {
            searchLanguage.setChecked(true);
            bookdescription.setText(R.string.political_descriptionDzo);
        ...
        searchLanguage.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    editor.putInt("politicalSwitchValue", 0);
                    editor.apply();
                    bookdescription.setText(R.string.political_descriptionDzo);
                    update(sharedPreferences);
                    search.setQueryHint("འཚོལ...");
                    ...
                    editor.putInt("politicalSwitchValue", 1);
                    editor.apply();
                    update(sharedPreferences);
                    bookdescription.setText(R.string.political_description);
