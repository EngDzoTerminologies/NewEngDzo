...
import ddc.dict.fragments.FragmentAcronym;
import ddc.dict.fragments.FragmentDzoDefinition;
import ddc.dict.fragments.FragmentSpeech;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getApplication().getSharedPreferences("computerpreference", 0);
      ...
      //  d = myDbHelper.getMeaning();
        ...
        if (c.moveToFirst()) {
            ...
            value=c.getString(c.getColumnIndex("_id"));
        ...
        btnBookmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i==0){
                   ...
                   // myDbHelper.deleteSingleBookmark(eng);
...
//        TextView toolbar = findViewById(R.id.mToolbar);
//        toolbar.setText(dzo);
//        Toolbar toolbar = findViewById(R.id.oToolbar);
//        getSupportActionBar(toolbar);
//        getSupportActionBar().setTitle(dzo);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(WordMeaningActivity.this, ComputerActivity.class);
